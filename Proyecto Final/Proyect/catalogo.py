...
"""
La función guardar_catalogo se encarga de guardar todo el catálogo en un archivo CSV. 
Primero convierte la lista de videojuegos en un DataFrame de pandas, revisa que tenga todas las columnas necesarias y, si falta alguna, la agrega.
Luego ordena las columnas correctamente y finalmente escribe el archivo CSV. 
En pocas palabras: esta función asegura que toda la información del catálogo quede guardada de manera limpia y organizada
"""